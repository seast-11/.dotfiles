				...
				lspconfig["gopls"].setup({
					...
					settings = {
						gopls = {
							...
							usePlaceholders = false, -- Enable placeholders in function signatures
							hoverKind = "FullDocumentation", -- Detailed hover information
							codelenses = {
								generate = true, -- Enable code lens for generate actions
								gc_details = true, -- Show gc annotations
								test = true, -- Enable code lens for testing
								tidy = true, -- Enable code lens for tidy actions
								upgrade_dependency = true, -- Enable code lens for dependency upgrades
							},
